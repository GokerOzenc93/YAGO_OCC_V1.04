    ...
    <div className="border border-stone-200 rounded-lg p-3 bg-white">
      ...
      <div className="mt-3">
        <div className="flex items-center gap-2">
          <label className="text-xs text-slate-600">Ana Gövde Tipi</label>
          <select
            value={selectedBodyType || ''}
            onChange={(e) => setSelectedBodyType(e.target.value)}
            className="text-xs px-2 py-1 bg-white border border-stone-200 rounded text-slate-700 focus:outline-none focus:border-orange-500"
          >
