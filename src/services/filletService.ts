...
import { extractFacesFromGeometry, createFaceDescriptor, groupCoplanarFaces } from './faceEditor';
import { convertReplicadToThreeGeometry } from './replicad';
import { getReplicadVertices } from './vertexEditor';

interface FilletData {
  face1Descriptor: any;
  face2Descriptor: any;
  face1Data: any;
  face2Data: any;
